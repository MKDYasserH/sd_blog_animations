...
class PaddingStride(Scene):
    def construct(self):      
        ...
        top_rect1 = Rectangle(width=3, height=2, grid_xstep=1, grid_ystep=1).scale(0.4)
        ...
        # Highlighting square
        highlighted_square1 = Rectangle(width=1, height=1, color=PURPLE, fill_opacity=1).scale(0.35).shift(DOWN/4.3+LEFT/2.5)
        highlighted_square2 = Rectangle(width=1, height=1, color=ORANGE, fill_opacity=1).scale(0.35).shift(DOWN/4.3+RIGHT*0.02)
        ...
        # Projection square
        proj_square = Rectangle(width=3, height=3, color=PURPLE, fill_opacity=0.4).scale(0.4).shift(DOWN*2.3+LEFT/8)
        proj_square.apply_function(lambda p: apply_shear(p, 0.7))
        proj_square2 = Rectangle(width=3, height=3, color=ORANGE, fill_opacity=0.4).scale(0.4).shift(DOWN*2.3+RIGHT/1.5)
        ...
        # Add dimensions
        dim1 = MathTex(r"(2\times 3)").scale(0.5).next_to(top_rect1, RIGHT, buff=1.1)
        ...
        info_text1 = MathTex(r"\text{Stride}=2")
